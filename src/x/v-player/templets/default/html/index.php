...
<head>
  ...
  <script type="text/javascript" src="public/js/class.main.js?time=<?php echo time(); ?>"></script>
  <?php
  ...
  <?php require_once TEMPLETS_PATH . $CONFIG["templets"]['html'] . '/config.php';
...
<body>
  ...
  <div class="fixed"></div>
  <div class="header">
    <div class="nav"> <i id="logo" class="logo"></i> <i id="list" class="list"> </i>
      <?php if (1 == $CONFIG["BOOK_INFO"]['off']): ?> <button class="btns-hamburger" onclick="xyplay.online()">
          <div class="AD_AD">
