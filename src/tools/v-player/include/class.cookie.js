...
var Cookie = new (class {
  ...
  set(key, value, other) {
    ...
    if ('object' === typeof other) {
      cookie += [
        'undefined' === typeof other.expires
          ? ''
          : '; expires=' + (expdate.setTime(expdate.getTime() + this.getTime(other.expires)), expdate.toUTCString()),
      ...
      cookie +=
        'undefined' === typeof other
          ? ''
          : '; expires=' + (expdate.setTime(expdate.getTime() + this.getTime(other)), expdate.toUTCString());
    }
