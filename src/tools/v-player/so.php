...
<body>
  <div id="clock">
    ...
    <div class="search bar6">
      ...
      <div>
        ...
        <font face="verdana" style="color:<?php echo $skin["color"] ?>;"> 接口地址：</font> <a style="color:<?php echo $skin["color"] ?>;"
          target="_top"
          href="./?v=https://v.qq.com/x/cover/brq7blajvjhrcit.html"><?php echo $CONFIG["ROOT_PATH"] ? $CONFIG["ROOT_PATH"] : GlobalBase::is_root() ?>?v=</a>
        <br /><br />
 ...
 -->
  ...
  function updateTime() {
    ...
    $('#text').text(zeroPadding(cd.getFullYear(), 4) + '-' + zeroPadding(cd.getMonth() + 1, 2) + '-' + zeroPadding(cd.getDate(), 2) + ' ' +
      week[cd.getDay()]);
    SiteTime(sitetime);
  };
