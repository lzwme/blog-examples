...
<body>
  <div class="video">
    <video id="video" controls="controls" x5-video-player-type="h5" playsinline="true" webkit-playsinline="true" x-webkit-airplay="allow"
  ...
  //h5播放信息补全
  if (is_mobile()) {
    video.innerHTML = '<source src="' + videoUrl + '" type="application/x-mpegURL"><source src="' + videoUrl +
      '" type="video/mp4"><source src="' + videoUrl + '" type="video/webm"><source src="' + videoUrl + '" type="video/ogg">您的浏览器不支持此视频播放！';
  ...
  //智能显示图片及控件
  if (is_mobile()) {
    videoObject["poster"] = "loading_wap.gif";
  }
  ...
  function myplay(url, time) {
    videoUrl = url;
    headtime = getCookie("time_" + videoUrl);
