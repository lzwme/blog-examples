...
<body> <?php echo base64_decode($CONFIG["HEADER_CODE"]) ?> <div class="fixed"></div>
  <div class="header">
    <div class="nav"> <i id="logo" class="logo"></i> <i id="list" class="list"> </i> <?php if (1 == $CONFIG["BOOK_INFO"]['off']): ?> <button
        class="btns-hamburger" onclick="xyplay.online()">
        <div class="AD_AD">
